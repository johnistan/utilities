CREATE TABLE "acustream"."npi_registry" (
  "npi" varchar,
  ...
  "provider_business_practice_location_address_country_code_if_out" varchar,
...
CREATE INDEX "npi_index" ON "acustream"."npi_registry" USING btree ("npi");


CREATE TABLE "acustream"."npi_registry_info" (
  "npi" varchar,
  "entity_type_code" varchar,
  "description" text,
  "provider_first_line_business_mailing_address" varchar,
...
CREATE INDEX "npi_info_index" ON "acustream"."npi_registry_info" USING btree ("npi");
